...
-- Started on 2026-02-18 15:24:24
...
-- Grant all privileges on public schema to current user and public role
-- This allows the restore to proceed even if user is not the schema owner
DO $$
BEGIN
...
EXCEPTION WHEN OTHERS THEN
    -- If grants fail, continue anyway (user may need to run as superuser)
    NULL;
END $$;
...
-- Name: enum_InventoryMovements_type; Type: TYPE; Schema: public; Owner: postgres
--
...
-- ALTER TYPE public."enum_InventoryMovements_type" OWNER TO postgres;
...
-- Name: EndOfDayReconciliations; Type: TABLE; Schema: public; Owner: postgres
--
...
-- ALTER TABLE public."EndOfDayReconciliations" OWNER TO postgres;

--
-- TOC entry 229 (class 1259 OID 33547)
-- Name: EndOfDayReconciliations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- ALTER SEQUENCE public."EndOfDayReconciliations_id_seq" OWNER TO postgres;

--
-- TOC entry 4969 (class 0 OID 0)
-- Dependencies: 229
-- Name: EndOfDayReconciliations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: ExpenseTypes; Type: TABLE; Schema: public; Owner: postgres
--
...
-- ALTER TABLE public."ExpenseTypes" OWNER TO postgres;

--
-- TOC entry 233 (class 1259 OID 41753)
-- Name: ExpenseTypes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- ALTER SEQUENCE public."ExpenseTypes_id_seq" OWNER TO postgres;

--
-- TOC entry 4970 (class 0 OID 0)
-- Dependencies: 233
-- Name: ExpenseTypes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- ALTER SEQUENCE public."InventoryMovements_id_seq" OWNER TO postgres;
...
-- Name: StartingCashes; Type: TABLE; Schema: public; Owner: postgres
--
...
-- ALTER TABLE public."StartingCashes" OWNER TO postgres;

--
-- TOC entry 231 (class 1259 OID 41746)
-- Name: StartingCashes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- ALTER SEQUENCE public."StartingCashes_id_seq" OWNER TO postgres;

--
-- TOC entry 4974 (class 0 OID 0)
-- Dependencies: 231
-- Name: StartingCashes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: TransactionItems_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- ALTER SEQUENCE public."TransactionItems_id_seq" OWNER TO postgres;

--
-- TOC entry 4975 (class 0 OID 0)
-- Dependencies: 225
-- Name: TransactionItems_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: EndOfDayReconciliations id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
-- Name: ExpenseTypes id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
-- Name: StartingCashes id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
-- Name: TransactionItems id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
-- Dependencies: 230
-- Data for Name: EndOfDayReconciliations; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 234
-- Data for Name: ExpenseTypes; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 232
-- Data for Name: StartingCashes; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 229
-- Name: EndOfDayReconciliations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 233
-- Name: ExpenseTypes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 231
-- Name: StartingCashes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 225
-- Name: TransactionItems_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Name: EndOfDayReconciliations EndOfDayReconciliations_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: EndOfDayReconciliations EndOfDayReconciliations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ExpenseTypes ExpenseTypes_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ExpenseTypes ExpenseTypes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: StartingCashes StartingCashes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: EndOfDayReconciliations EndOfDayReconciliations_closedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: InventoryMovements InventoryMovements_relatedTransactionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: TransactionItems TransactionItems_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2026-02-18 15:24:24
